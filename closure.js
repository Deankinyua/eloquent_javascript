...
// * But what if we intend to manipulate that variable afterwards in other words "mutate it"? What if
// * we also want to get the best of both worlds? The concept of closures comes to the rescue. They are
// * a means to capture a particular value or "close it" such that we can continue manipulating the variable
// * while also preserving an initial value of that specific variable
